...
/**
 *
 * Using a string input as seed, generates a pseudo-random sequence of bytes.
...
public class PNRGStreamCipher {
     ...
     * @param key the key
     */
    public PNRGStreamCipher(String key) {
        this.key = key;
    }
     ...
     * The seed of the SecureRandom instance is the byte sequence representation of the field {@link this::key}.
    ...
    /**
     * Decrypts the given input byte sequence by calling internally the {@link this::encrypt} method. This is valid
